...
const CourseDetails = () => {
  ...
  const {allCourses ,currency, calculateRating , calculateChapterTime, calculateCourseDuration,  calculateNoOfLectures} = useContext(AppContext)
  ...
  return courseData ? (
    ...
    <div className="max-w-xl z-10 text-gray-500">
      ...
      <p className="pt-4 md:text-base text-sm" dangerouslySetInnerHTML={{ __html: courseData.courseDescription.slice(0, 200) }}>
       ...
       <p className='text-sm'>Course by <span className='text-blue-600 underline'>Saurabh Tripathi</span></p>
